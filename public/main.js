...
var CartComponent = /** @class */ (function () {
    function CartComponent(data, http) {
        var _this = this;
        this.data = data;
        this.http = http;
        this.myRadio = '';
    ...
    CartComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], CartComponent);
...
var ChngpwdComponent = /** @class */ (function () {
    ...
    ChngpwdComponent.prototype.postdata = function (data1) {
        ...
        if (data1.password === data1.repassword) {
            this.http.post('/api/chngpwd', data1).subscribe(function (data) {
                if (data['message']) {
...
var HistoryComponent = /** @class */ (function () {
    ...
    HistoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.post('/chkout/checkoutfetch', { User_id: localStorage.getItem('userId') }).subscribe(function (data) {
            console.log(data);
            _this.wish = data;
        });
    };
...
var YourproductsComponent = /** @class */ (function () {
    ...
    YourproductsComponent.prototype.load = function () {
        var _this = this;
        this.http.post('/api/remove', { User_id: localStorage.getItem('userId') }).subscribe(function (data) {
            console.log(data);
            _this.pro = data;
        });
    };
    YourproductsComponent.prototype.remove_book = function (data1) {
        var _this = this;
        this.http.post('/api/remove/remove_complete', { User_id: localStorage.getItem('userId'), Product_id: data1 }).subscribe(function (data) {
            _this.load();
        });
    };
...
module.exports = __webpack_require__(/*! F:\Bookshala_Final\project\src\main.ts */"./src/main.ts");
